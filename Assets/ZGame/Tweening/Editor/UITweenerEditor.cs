...
public class UITweenerEditor : Editor
{
    ...
    private bool m_ChangeAble = false;
    ...
    protected void DrawCommonProperties()
    {
        ...
        if (DrawHeader("TweenBase"))
        {
            ...
            m_ChangeAble = EditorGUILayout.Toggle("Change Value", m_ChangeAble);
            ...
            bool startFromFrom = EditorGUILayout.Toggle("Start With From Value", tw.startFromFrom, GUILayout.Width(170f));
            ...
            if (GUI.changed)
            {
                ...
                tw.duration = dur;
                tw.delay = del;
                tw.startFromFrom = startFromFrom;
