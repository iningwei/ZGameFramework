...
public abstract class UITweener : MonoBehaviour
{
    ...
    public bool startFromFrom = true;
    ...
    void Update()
    {
        ...
        UpdateValue(delta, time);
    }


    public void UpdateValue(float delta, float time) {
        if(!mStarted) {
            mStarted = true;
    ...
    /// </summary>
    public virtual void PlayForward() { Play(true); }

    /// <summary>
    /// Play the tween in reverse.
    /// </summary>
    public virtual void PlayReverse() { Play(false); }
    ...
    public void ResetTo(float factor) {
        OnUpdate(factor, false);
    }
