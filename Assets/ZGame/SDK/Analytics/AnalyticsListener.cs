...
this.Main_AD_BtnClick_Speedup);
        ...
        EventDispatcher.Instance.AddListener(AnalyticsEventID.Build_BtnClick_GemBuild, this.Build_BtnClick_GemBuild);
        EventDispatcher.Instance.AddListener(AnalyticsEventID.Build_AD_BtnClick_GemBuild, this.Build_AD_BtnClick_GemBuild);
        EventDispatcher.Instance.AddListener(AnalyticsEventID.Build_BtnClick_NOThanks, this.Build_BtnClick_NOThanks);
        
        EventDispatcher.Instance.AddListener(AnalyticsEventID.Dash_Enter, this.Dash_Enter);
        EventDispatcher.Instance.AddListener(AnalyticsEventID.Dash_Exit, this.Dash_Exit);
        
        EventDispatcher.Instance.AddListener(AnalyticsEventID.Shop_BtnClick_FreeGem, this.Shop_BtnClick_FreeGem);
        EventDispatcher.Instance.AddListener(AnalyticsEventID.Shop_BtnClick_Gem_500, this.Shop_BtnClick_Gem_500);
        EventDispatcher.Instance.AddListener(AnalyticsEventID.Shop_BtnClick_NOAD, this.Shop_BtnClick_NOAD);
        EventDispatcher.Instance.AddListener(AnalyticsEventID.Shop_BtnClick_Gem_150, this.Shop_BtnClick_Gem_150);
        EventDispatcher.Instance.AddListener(AnalyticsEventID.Shop_BtnClick_Gem_2000, this.Shop_BtnClick_Gem_2000);
        EventDispatcher.Instance.AddListener(AnalyticsEventID.Shop_BtnClick_Gem_15000, this.Shop_BtnClick_Gem_15000);

        EventDispatcher.Instance.AddListener(AnalyticsEventID.Main_BtnClick_Shop, this.Main_BtnClick_Shop);
       
        EventDispatcher.Instance.AddListener(AnalyticsEventID.Build_Enter, this.Build_Enter);
        
        EventDispatcher.Instance.AddListener(AnalyticsEventID.Clear_Enter, this.Clear_Enter);
        EventDispatcher.Instance.AddListener(AnalyticsEventID.Clear_Finish, this.Clear_Finish);
    }
  
    private void Clear_Finish(string evtId, object[] paras)
    {
        AnalyticsSdkManager.Instance.LogEvent(evtId);
    }
    
    private void Clear_Enter(string evtId, object[] paras)
    {
        AnalyticsSdkManager.Instance.LogEvent(evtId);
    }
    
    private void Build_Enter(string evtId, object[] paras)
    {
        AnalyticsSdkManager.Instance.LogEvent(evtId);
    }
    
    private void Main_BtnClick_Shop(string evtId, object[] paras)
    {
        AnalyticsSdkManager.Instance.LogEvent(evtId, "CityId", (int) paras[0]);
    }
   
    private void Shop_BtnClick_Gem_15000(string evtId, object[] paras)
    {
        AnalyticsSdkManager.Instance.LogEvent(evtId);
    }
    private void Shop_BtnClick_Gem_2000(string evtId, object[] paras)
    {
        AnalyticsSdkManager.Instance.LogEvent(evtId);
    }
    private void Shop_BtnClick_Gem_150(string evtId, object[] paras)
    {
        AnalyticsSdkManager.Instance.LogEvent(evtId);
    }
    private void Shop_BtnClick_NOAD(string evtId, object[] paras)
    {
        AnalyticsSdkManager.Instance.LogEvent(evtId);
    }
    private void Shop_BtnClick_Gem_500(string evtId, object[] paras)
    {
        AnalyticsSdkManager.Instance.LogEvent(evtId);
    }
    private void Shop_BtnClick_FreeGem(string evtId, object[] paras)
    {
        AnalyticsSdkManager.Instance.LogEvent(evtId);
    }
    
    private void Dash_Exit(string evtId, object[] paras)
    {
        AnalyticsSdkManager.Instance.LogEvent(evtId, "CityId",  paras[0].ToString(), "progress",paras[1].ToString());
    }
   
    private void Dash_Enter(string evtId, object[] paras)
    {
        AnalyticsSdkManager.Instance.LogEvent(evtId, "CityId",  paras[0].ToString(), "progress",paras[1].ToString());
    }
  
    private void Build_BtnClick_NOThanks(string evtId, object[] paras)
    {
        AnalyticsSdkManager.Instance.LogEvent(evtId, "CityId", (int) paras[0]);
    }
    private void Build_AD_BtnClick_GemBuild(string evtId, object[] paras)
    {
        AnalyticsSdkManager.Instance.LogEvent(evtId, "CityId", (int) paras[0]);
    }
    private void Build_BtnClick_GemBuild(string evtId, object[] paras)
    {
        AnalyticsSdkManager.Instance.LogEvent(evtId, "CityId", (int) paras[0]);
    }
