...
namespace ZGame.SDK
{
    public class IronSourceAdSdkManager : AdSdkBase
    {
        ...
        public string IOS_APP_KEY = "e24c8211";
        ...
        private bool isAdShowSuccess = false;
        ...
        public override void Init()
        {
         ...
         IronSource.Agent.init(IOS_APP_KEY);
            ...
            {
                if (GameData.Instance.commonData.isNoAds != 1)
                {
                    this.LoadBanner();
                    this.ShowBanner();
                }
        ...
        void onRewardedVideoAdClosed()
        {
            ...
            Debug.Log("isShowSuccess:" + isAdShowSuccess);
            OnAdClose?.Invoke(isAdShowSuccess);
            Time.timeScale = 1;
        }
