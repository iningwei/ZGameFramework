...
public class TypeTextComponent : MonoBehaviour
{
    ...
    public void SetText(string text, float speed = -1, bool useRealTime = false)
    {
        Init();
    ...
    public IEnumerator TypeText(string text)
    {
        ...
        for (var i = 0; i < len; i++)
        {
            ...
            //color只支持#开头的,如<color=#1D07FFFF></color>，不支持诸如<color=red></color>这种
            //TODO:后期支持
...
public static class TypeTextComponentUtility
{
    ...
    public static void TypeText(this Text label, string text, float speed = 0.05f, bool useRealTime = false, TypeTextComponent.OnComplete onComplete = null)
    {
        ...
        typeText.SetText(text, speed,useRealTime);
