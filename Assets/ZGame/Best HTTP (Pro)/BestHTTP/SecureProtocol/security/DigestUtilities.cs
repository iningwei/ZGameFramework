...
namespace Org.BouncyCastle.Security
{
    ...
    public sealed class DigestUtilities
    {
        ...
        static DigestUtilities()
        {
            ...
            ((DigestAlgorithm)Org.BouncyCastle.Utilities.Enums.GetArbitraryValue(typeof(DigestAlgorithm))).ToString();
...
//			algorithms[TeleTrusTObjectIdentifiers.RipeMD320.Id] = "RIPEMD320";
            ...
            string algorithm)
        {
            ...
            try
            {
                DigestAlgorithm digestAlgorithm = (DigestAlgorithm)Org.BouncyCastle.Utilities.Enums.GetEnumValue(
