...
namespace ZGame
{
    public class CryptoTool
    {
        ...
        public static string DesEncryptStrWithHex(string content, string key)
        {
            if (key.Length != 8)
            {
                DebugExt.LogE("DesEncryptStr error des need key has 8 char");
                return "";
            }
        ...
        public static string DesDecryptStrFromHex(string content, string skey)
        {
            if (skey.Length != 8)
            {
                DebugExt.LogE("DesDecryptStr error des need key has 8 char");
                return "";
            }
            try
            {
            ...
            {
                DebugExt.LogE("DesDecryptStrFromHex error, content:" + content + ", ex:" + ex.ToString());
                return null;
            }
